        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6">
              {/* Product Image */}
              <div className="tf-product-media-wrap bg-white thumbs-default sticky-top">
            ...
            <div className="col-md-6">
              {/* Product Infor */}
              <div className="tf-product-info-wrap bg-white position-relative">
                <div className="tf-zoom-main" />
                <div className="tf-product-info-list style-2 justify-content-xl-end">
